...
function Footer() {
  return (
    <div className="footer py-8 min-w-80 dark:bg-gray-900 text-gray-400">
      <div className="max-w-80 mx-auto md:max-w-4xl flex flex-col items-center">
        ...
        <div className="mt-8">
          <p className="pl-9">&copy; 2024 Somnath Chattaraj (somnathchattaraj5@gmail.com)</p>
        </div>
