...
import './UranusCarousel.css'; // Import CSS file containing provided styles
...
function UranusCarousel() {
  ...
  return (
    <div className="dark:bg-black text-gray-300 px-4 md:px-10 lg:px-20 xl:px-32 pt-10 md:pt-20">
      <div className="max-w-80 mx-auto md:max-w-4xl">

        <img src={uranus_token} alt="" className="pb-5 mx-auto"/>
        <h1 className="text-4xl font-bold text-center pb-8"> $URANUS</h1>
        <p className="pb-8">
